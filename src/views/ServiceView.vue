    ...
    <div class="s-c-right">
      <div class="service-card">
        <div class="service-icon">
          <svg viewBox="0 0 24 24" class="design-icon">
            <path
              fill="currentColor"
        ...
        <div class="service-text">Graphic Design</div>
      </div>
      <div class="service-card">
        <div class="service-icon">
          <svg viewBox="0 0 24 24" class="design-icon">
        ...
        <div class="service-text">Printing Banners</div>
      </div>
      <div class="service-card">
        <div class="service-icon">
          <svg viewBox="0 0 24 24" class="design-icon">
        ...
        <div class="service-text">Creating Signage</div>
      </div>
    </div>
    <div class="s-c-left">
      <div class="service-card">
        ...
        <div class="service-text">Car Branding</div>
      </div>
      <div class="service-card">
        <div class="service-icon">
          <svg viewBox="0 0 24 24" class="design-icon">
        ...
        <div class="service-text">Creating BillBoards</div>
      </div>
      <div class="service-card">
        <div class="service-icon">
          <svg viewBox="0 0 24 24" class="design-icon">
        ...
        <div class="service-text">Paid Delivery</div>
      </div>
    </div>
  </div>
</template>
